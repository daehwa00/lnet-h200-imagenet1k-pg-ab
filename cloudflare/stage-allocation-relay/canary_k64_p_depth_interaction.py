"""Exercise the K64 P-depth-interaction relay with its permanent W&B canary."""
...
def main() -> None:
    ...
    run = wandb.init(
        ...
        config={
            ...
            "purpose": "permanent K64-P-depth-interaction relay canary; never experiment evidence",
        ...
        settings=wandb.Settings(
            ...
            x_extra_http_headers={
                "User-Agent": "Mozilla/5.0 lnet-h200-k64-p-depth-interaction-canary/1"
            },
    ...
    if "filestream: fatal error" in internal_text:
        ...
        raise RuntimeError(message)
    print(f"H200_K64_P_DEPTH_INTERACTION_RELAY_CANARY_OK={run.url}", flush=True)
