...
output_root=${2:-.omx/results/pac-selected-d64m16-external-20260711}
mode=${3:-launch}
worker_id=${4:-0}
...
log_root="$project_root/.omx/logs/pac-selected-d64m16-external-20260711"
models=(pac tcn cnn1d transformer mamba gru lstm s4 s4d minirocket inception_time)
seeds=(7 11 19)
datasets=(
