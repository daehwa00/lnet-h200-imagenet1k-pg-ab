#!/usr/bin/env python3
"""Train the frozen LNet K64/P80x4/D2262 on ImageNet-1K."""
    ...
    os.environ.update(
        {
            ...
            "H200_BASELINE_DISPLAY_NAME": f"H200-LNet-I1K-K64-P80x4-s{seed}",
...
def main() -> None:
    ...
    print("LNET_K64_IMAGENET1K_RESULT_JSON=" + json.dumps(result, sort_keys=True), flush=True)
