#!/usr/bin/env python3
"""Run the Fusion384 ResAux model with affine auxiliary weight 0.5."""
...
import run_a2d_resaux1_imagenet100 as source

if TYPE_CHECKING:
    from argparse import Namespace


VARIANT = "A2D-ResAux05-F384"
...
def _contract(args: Namespace) -> dict[str, Any]:
    ...
    payload["schema"] = "lnet.a2d.resaux05_f384.imagenet100.v1"
    ...
    payload["architecture"][VARIANT] = (
        "A2D-ResAux1 Fusion384 with affine Q auxiliary CE weight 0.5; "
        "all backbone, path-combination, residual, and optimizer settings unchanged."
    )
    payload["source_sha256"]["resaux05_f384_runner"] = (
        source.heads.harness._digest(Path(__file__))
    )
