...
"""Train the two-PoleDown plus terminal-bank variant on CIFAR-100."""
...
VARIANTS = ("static_pole_pyramid_a_terminal",)
SEEDS = (401,)


def _build(variant: str, config: PolePyramidATerminalTinyConfig) -> PolePyramidATerminalTiny:
    if variant != VARIANTS[0]:
        message = f"unknown terminal PolePyramid-A variant: {variant}"
...
def _contract(args: Namespace) -> dict[str, Any]:
    ...
    payload = {
        "schema": "lnet.polepyramid_a_terminal.cifar100.v1",
        "evidence_status": "single-seed exploratory terminal-bank screen",
