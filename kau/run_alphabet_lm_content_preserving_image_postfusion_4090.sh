...
readonly LABEL="content-fullcausal-assoc-learnbeta-f256-h4p8k64-l19-fromscratch-30m"
...
export WANDB_GROUP="ALPHABET-LM-RTX4090-Content-FullCausal-Assoc-LearnBeta-F256-H4P8K64-30M-S501-v13"
...
timeout --signal=TERM --kill-after=5m 8h \
  ...
  --laplace-mamba-parallel-static-scan \
