"""CLI for the 30-task H-compact overnight architecture screen."""
...
from .pac_h_compact_overnight_campaign import (
    DEFAULT_ROOT,
    enqueue,
    report,
    run_manifest,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="H-compact 30-task overnight screen")
    parser.add_argument(
        "--stage",
