"""CLI for the tied H-compact lag-(1,2,4) 30-task Q1 campaign."""
...
from .pac_h_compact_lag124_tied_q1_campaign import (
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Tied H-compact lag-(1,2,4) 30-task Q1")
    parser.add_argument(
        "--stage",
        choices=(
            "enqueue-stage1",
